...
<Note>
  ...
  functionality provided by `build_asset_reconciliation_sensor`. However, this
  example provides a starting point for those wishing to customize this behavior
  beyond what the pre-built sensor supports.
</Note>
