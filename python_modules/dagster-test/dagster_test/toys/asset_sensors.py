...
@multi_asset_sensor(
    monitored_asset_selection=[AssetKey("asset_c"), AssetKey("asset_d")],
    job=log_asset_sensor_job,
)
...
@multi_asset_sensor(
    monitored_asset_selection=[AssetKey("my_string_asset"), AssetKey("my_int_asset")],
    job=log_asset_sensor_job,
)
...
@multi_asset_sensor(
    monitored_asset_selection=[AssetKey("asset_a")],
    job=log_asset_sensor_job,
)
