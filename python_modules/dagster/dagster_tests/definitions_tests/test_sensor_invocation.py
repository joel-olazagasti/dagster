...
def test_multi_asset_sensor():
    ...
    @multi_asset_sensor(
        monitored_asset_selection=[AssetKey("asset_a"), AssetKey("asset_b")], job=the_job
    )
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[AssetKey("asset_a"), AssetKey("asset_b")],
            instance=instance,
...
def test_multi_asset_sensor_selection():
    ...
    @multi_asset_sensor(monitored_asset_selection=[AssetKey("asset_a")])
...
def test_multi_asset_sensor_has_assets():
    ...
    @multi_asset_sensor(monitored_asset_selection=[AssetKey("asset_a"), AssetKey("asset_b")])
...
def test_multi_asset_sensor_invalid_partitions():
    ...
    with instance_for_test() as instance:
        with build_multi_asset_sensor_context(
            monitored_asset_selection=[static_partitions_asset.key],
            instance=instance,
            repository_def=my_repo,
        ) as context:
...
def test_partitions_multi_asset_sensor_context():
    ...
    @multi_asset_sensor(
        monitored_asset_selection=[daily_partitions_asset.key, daily_partitions_asset_2.key]
    )
...
def test_multi_asset_sensor_after_cursor_partition_flag():
    @multi_asset_sensor(monitored_asset_selection=[july_asset.key])
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[july_asset.key], instance=instance, repository_def=my_repo
        )
...
def test_multi_asset_sensor_custom_partition_mapping():
    ...
    @multi_asset_sensor(monitored_asset_selection=[july_daily_partitions.key])
    def asset_sensor(context):
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[july_daily_partitions.key],
            instance=instance,
            repository_def=my_repo,
        )
        asset_sensor(ctx)
...
def test_multi_asset_sensor_update_cursor_no_overwrite():
    @multi_asset_sensor(monitored_asset_selection=[july_asset.key, august_asset.key])
    def after_cursor_partitions_asset_sensor(context):
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[july_asset.key, august_asset.key],
            instance=instance,
            repository_def=my_repo,
        )
        after_cursor_partitions_asset_sensor(ctx)
...
def test_multi_asset_sensor_latest_materialization_records_by_partition_and_asset():
    @multi_asset_sensor(monitored_asset_selection=[july_asset.key, july_asset_2.key])
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[july_asset.key, july_asset_2.key],
            instance=instance,
            repository_def=my_repo,
        )
        my_sensor(ctx)
...
def test_build_multi_asset_sensor_context_asset_selection():
    ...
    @multi_asset_sensor(
        monitored_asset_selection=AssetSelection.groups("ladies").upstream(
            depth=1, include_self=False
        )
    )
...
def test_build_multi_asset_sensor_context_asset_selection_set_to_latest_materializations():
    ...
    @multi_asset_sensor(monitored_asset_selection=[my_asset.key])
    def my_sensor(context):
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=AssetSelection.groups("default"),
            instance=instance,
...
def test_build_multi_asset_sensor_context_set_to_latest_materializations():
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[my_asset.key],
            instance=instance,
            cursor_from_latest_materializations=True,
            repository_def=my_repo,
        )
...
def test_build_multi_asset_context_set_after_multiple_materializations():
    ...
    with instance_for_test() as instance:
        ...
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[my_asset.key, my_asset_2.key],
            instance=instance,
            cursor_from_latest_materializations=True,
            repository_def=my_repo,
        )
...
def test_error_not_thrown_for_skip_reason():
    ...
    with instance_for_test() as instance:
        ctx = build_multi_asset_sensor_context(
            monitored_asset_selection=[july_asset.key],
            repository_def=my_repo,
            instance=instance,
        )
        test_unconsumed_events_sensor(ctx)
