...
@multi_asset_sensor(monitored_asset_selection=[AssetKey("asset_a")], job=the_job)
...
@multi_asset_sensor(monitored_asset_selection=[hourly_asset.key], job=weekly_asset_job)
...
@multi_asset_sensor(monitored_asset_selection=[hourly_asset.key], job=hourly_asset_job)
...
@multi_asset_sensor(monitored_asset_selection=[AssetKey("a_source_asset")], job=the_job)
